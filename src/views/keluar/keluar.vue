 ...
 <div class="background-container">
    ...
    <div v-if="showModal" class="modal-overlay" @click.self="showModal = false">
      <div class="modal-content">
        <h4 style="text-align: center; color: #28a745; font-weight: bolder;">TAMBAH SURAT KELUAR</h4>
        ...
        <div class="form-group-row">
          ...
          <div class="form-group">
            <label for="tanggalkirim" style="width: 195px;">Tanggal Kirim</label>
            <input type="date" id="tanggalkirim" v-model="formData.tanggalkirim" />
          </div>
        </div>
        <div class="form-group">
